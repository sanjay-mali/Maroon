    ...
    <>
      <div className="container-custom py-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          >
            <h1 className="text-2xl md:text-3xl font-bold">Banarasi Silk Saree</h1>
            ...
            <div className="mt-2">
              ...
              <span className="ml-2 bg-red-100 text-red-700 px-2 py-1 rounded-full text-xs font-medium">-30%</span>
            </div>
          ...
          <Tabs defaultValue="description" className="mb-16">
            ...
            <TabsContent value="description" className="mt-6">
              <div className="prose max-w-none">
                <p>
                  This exquisite Banarasi Silk Saree combines traditional craftsmanship with contemporary design.
                  Handwoven by skilled artisans in Varanasi, this saree features intricate zari work and a rich pallu
                  that adds elegance to your festive wardrobe.
                </p>
                <p>
                  The vibrant colors and timeless design make it perfect for weddings, festivals, and special occasions.
                  Each piece is unique and represents the rich cultural heritage of Indian textiles.
                </p>
              </div>
            </TabsContent>
